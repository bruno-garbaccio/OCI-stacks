...
variable use_existing_api_gw {default = "false"}
variable api_gw_id {default = ""}
variable use_existing_registry {default = "false"}
variable registry_id {default = ""}
variable web_submission_portal {default = "false"}
variable use_existing_vault {default = "false"}
variable vault_id {default = ""}
variable use_existing_master_key {default = "false"}
variable master_key_id {default = ""}
variable use_existing_auth_token {default = "false"}
variable auth_token {default = ""}
variable build_app { default = "false"}
